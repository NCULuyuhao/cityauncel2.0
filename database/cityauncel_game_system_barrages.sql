...
-- 檔案用途：MySQL schema 腳本 cityauncel_game_system_barrages.sql，定義資料表、索引或資料庫重建流程。
...
--
-- Table structure for table `barrages`
--
...
--
-- Dumping data for table `barrages`
--

LOCK TABLES `barrages` WRITE;
/*!40000 ALTER TABLE `barrages` DISABLE KEYS */;
/*!40000 ALTER TABLE `barrages` ENABLE KEYS */;
UNLOCK TABLES;
