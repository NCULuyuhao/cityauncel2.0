...
--
-- Table structure for table `inquiry_records`
--
...
--
-- Dumping data for table `inquiry_records`
--

LOCK TABLES `inquiry_records` WRITE;
/*!40000 ALTER TABLE `inquiry_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `inquiry_records` ENABLE KEYS */;
UNLOCK TABLES;
