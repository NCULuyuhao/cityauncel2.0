...
-- 檔案用途：MySQL schema 腳本 cityauncel_game_system_suspect_votes.sql，定義資料表、索引或資料庫重建流程。
...
--
-- Table structure for table `suspect_votes`
--
...
--
-- Dumping data for table `suspect_votes`
--

LOCK TABLES `suspect_votes` WRITE;
/*!40000 ALTER TABLE `suspect_votes` DISABLE KEYS */;
/*!40000 ALTER TABLE `suspect_votes` ENABLE KEYS */;
UNLOCK TABLES;
