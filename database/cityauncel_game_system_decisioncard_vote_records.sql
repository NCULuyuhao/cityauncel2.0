...
--
-- Table structure for table `decisioncard_vote_records`
--
...
CREATE TABLE `decisioncard_vote_records` (
  ...
  `vote_type` enum('agree','reject','keep') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'keep',
...
--
-- Dumping data for table `decisioncard_vote_records`
--

LOCK TABLES `decisioncard_vote_records` WRITE;
/*!40000 ALTER TABLE `decisioncard_vote_records` DISABLE KEYS */;
/*!40000 ALTER TABLE `decisioncard_vote_records` ENABLE KEYS */;
UNLOCK TABLES;
