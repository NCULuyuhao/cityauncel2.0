...
-- 檔案用途：MySQL schema 腳本 cityauncel_game_system_inquiry_collection_notes.sql，定義資料表、索引或資料庫重建流程。
...
--
-- Table structure for table `inquiry_collection_notes`
--
...
--
-- Dumping data for table `inquiry_collection_notes`
--

LOCK TABLES `inquiry_collection_notes` WRITE;
/*!40000 ALTER TABLE `inquiry_collection_notes` DISABLE KEYS */;
/*!40000 ALTER TABLE `inquiry_collection_notes` ENABLE KEYS */;
UNLOCK TABLES;
